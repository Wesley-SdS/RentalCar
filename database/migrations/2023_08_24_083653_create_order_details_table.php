...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->string(column:'neighborhood', length:255)->nullable();
            $table->string(column:'complement', length:255)->nullable();
            $table->string( column:'city', length:255);
            $table->string( column:'state', length:45)->nullable();
            $table->string( column:'zipcode', length:45);
            $table->string( column:'country-code', length:3);
            $table->string(column:'reference', length:255)->nullable();
            $table->timestamps();
        });
    }
