  ...
  <div v-if="order">
    ...
    <div>
      ...
      <table>
        <tbody>
        <tr>
          <td class="font-bold py-1 px-2">Reserva #</td>
          <td>{{ order.id }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Data da Reserva</td>
          <td>{{ order.created_at }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Reserva Status</td>
          <td>
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          <td class="font-bold py-1 px-2">E-mail</td>
          <td>{{ order.customer.email }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Telefone</td>
