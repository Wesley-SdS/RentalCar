    ...
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
        <div class="flex justify-between border-b-2 pb-3">
            <div class="flex items-center">
                <span class="whitespace-nowrap mr-3">Por pagina</span>
                ...
                <span class="ml-3">Produtos {{ products.total }} Encontrados</span>
            </div>
            <div>
                <input
                    v-model="search"
        ...
        <table class="table-auto w-full">
            <thead>
                <tr>
                    ...
                    >
                        Útima atualização em
                    </TableHeaderCell>
                    <TableHeaderCell field="actions"> Ação </TableHeaderCell>
                </tr>
            </thead>
...
const productsAvailable = computed(() => products.value && products.value.data);
